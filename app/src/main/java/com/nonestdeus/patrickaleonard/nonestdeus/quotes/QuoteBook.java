...
public class QuoteBook {
    ...
    private static final Quote[] nQuoteArray = new Quote[]{
            ...
            new Quote(R.string.dikkers_quote_1, R.string.dikkers_author),
            ...
            new Quote(R.string.rorty_quote_1, R.string.rorty_author),
            ...
            new Quote(R.string.sartre_quote_1, R.string.sartre_author),
